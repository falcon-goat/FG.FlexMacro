	...
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 3,
					"patching_rect" : [ 528.0, 396.0, 46.0, 18.0 ],
					"id" : "obj-50",
					"fontname" : "Arial Bold",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 1,
					"patching_rect" : [ 488.0, 376.0, 16.0, 16.0 ],
					"presentation" : 1,
					"id" : "obj-48",
					"outlettype" : [ "int" ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 320.0, 564.0, 59.0, 18.0 ],
					"id" : "obj-46",
					"fontname" : "Arial Bold",
					"fontsize" : 10.0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 2,
					"patching_rect" : [ 320.0, 528.0, 40.0, 20.0 ],
					"presentation" : 1,
					"id" : "obj-44",
					"parameter_enable" : 1,
					"outlettype" : [ "", "" ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"id" : "obj-7",
					"name" : "M4L.api.FG.Parameter.ControlViaRemote.NoSplit.maxpat",
					"args" : [  ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 1,
					"patching_rect" : [ 476.0, 434.0, 85.0, 16.0 ],
					"id" : "obj-35",
					"fontname" : "Arial Bold",
					"outlettype" : [ "" ],
					"fontsize" : 10.0
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 1,
					"patching_rect" : [ 564.0, 434.0, 66.0, 16.0 ],
					"id" : "obj-49",
					"fontname" : "Arial Bold",
					"outlettype" : [ "" ],
					"fontsize" : 10.0
